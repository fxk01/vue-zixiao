  ...
  export default {
    ...
    data() {
      return {
        ...
        filtertype:0,  //0：全部最新问题； 1：只看没有回答的最新问题
        newListData:[],
        page: 1,  //第一页
        pagesize: 10, //每页条数
        Len:0, //已加载的数据条数
    ...
    destroyed() {
      ...
      //
      // window.removeEventListener('scroll',this.scrollChangeNew)
      // this.$off('pullRefresh',()=>{
      //   console.log(123456)
      // })
    },
    mounted() {
      this.loading = this.$loading({
        // lock: true,
        text: 'Loading',
        target:document.querySelector('#newpage')
...
//        window.open(routerWriteAnswer.href, '_blank');
      ...
      pullRefresh: function () {
        var _this = this;
        common.addEvent(window,'scroll', this.scrollChangeNew)
      },

      scrollChangeNew: function () {
        var _this = this;
