<template>
  ...
  <div id="newsWrap" class="body-warpper">
    ...
    <carousel></carousel>
    <div class="container main-container with-view-nav">
      <div class="view timeLine-index-view">
        <div class="fl main-left">
          <!--正文-->
          <div v-if="!noData">
            <ul class="main-wrapper">
              <li v-for="(messageList,index) in messageData" :key="messageList.id" @click="goAnswerPage(index,messageList.isRead,messageList.id)" class="flex flex-align-center item-news">
                <!--<div class="bg-thumb">-->
                ...
                <div :class="messageList.isRead=='1'?'innerTxt_active':''" class="flex-1 item-main">
                  ...
                  <div v-if="messageList.hot_contents" >
                    <div v-html="messageList.contentReplenish && messageList.contentReplenish.length==0?messageList.hot_contents:messageList.contentReplenish[0]" class="p-content"></div>
                  </div>
...
<style lang="less" src="./sysnews.less"></style>
